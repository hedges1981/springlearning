 ...
 */
//	DONE-02:  Review the JPA annotations on this class and make sure you know what each does.
//	@Embedded - Marks an embedded relationship, where columns on the T_ACCOUNT_BENEFICIARY table are used to populated.
