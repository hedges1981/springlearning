...
public class RewardNetworkImpl implements RewardNetwork
{
    ...
    public RewardConfirmation rewardAccountFor( Dining dining )
    {
        ...
        Restaurant rest = restaurantRepository.findByMerchantNumber( dining.getMerchantNumber() );
        MonetaryAmount ma = rest.calculateBenefitFor( account, dining );

        AccountContribution accountContribution = account.makeContribution( ma );
