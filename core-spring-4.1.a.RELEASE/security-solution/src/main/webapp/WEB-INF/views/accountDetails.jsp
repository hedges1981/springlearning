...
<head>
	...
	<link rel="stylesheet" href="<c:url value="resources/styles/spring.css"/>" type="text/css"/>
...
<c:if test="${principal != null}">
	<p><form:form action="../logout" method="post"><input type="submit" value="Logout"/></form:form> (${principal.username})</p>
</c:if>
